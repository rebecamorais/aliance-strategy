    ...
    <main className="flex min-h-screen flex-col items-center justify-center bg-page p-4 font-sans text-body">
      <div className="w-full max-w-sm rounded-2xl bg-surface p-8 border border-border text-center shadow-2xl">
        <div className="mb-6">
          ...
          <p className="text-sm text-muted mt-1">Escolha uma forma de autenticação.</p>
        </div>
        ...
        <div className="space-y-3">
          ...
          >
            ...
            {isLoading === "discord" ? "Conectando..." : "Entrar com Discord"}
          </button>
          ...
          <button
            ...
            disabled={isLoading !== null}
            className="flex w-full items-center justify-center gap-3 rounded-xl bg-white border border-zinc-200 px-4 py-3.5 font-medium text-zinc-950 transition-all hover:bg-zinc-50 active:scale-[0.98] disabled:opacity-50 disabled:pointer-events-none cursor-pointer"
          >
